...
namespace KlinikaProjekt.Controllers
{
    public class PharmaciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description,Quantity,Image")] Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description,Quantity,Image")] Pharmacy pharmacy)
        {
            if (id != pharmacy.Id)
            {
                return NotFound();
